...
const displayAllRecipes = () =>{
    for(let i=0; i< recipes.length; i++){
        recipesContainer.innerHTML += `     <article class="col-12 col-md-6 col-lg-4 g-3 mb-2">
                                                <div class="card p-0">
                                                    ...
                                                    <div class="card-body row g-0">
                                                        <div class="d-flex justify-content-between align-items-center col-12">
                                                            <h2 class="card-title h2">${recipes[i].name}</h2>
                                                            <p class="card-text text-nowrap h4"><i class="bi bi-clock h4"></i> ${recipes[i].time} min</p>
                                                        </div>
                                                        <div class="card-text col-6">${putIngredientsInList(recipes[i].ingredients)}</div>
                                                        <p class="card-text col card__description text-truncate h6">${recipes[i].description}</p>
